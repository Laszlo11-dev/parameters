...
// ignore_for_file: prefer_final_fields, deprecated_member_use, must_be_immutable
...
///
/// {@tool dartpad}
/// This example shows a [OptimizedFloatingActionButton] in its usual position within a
...
///
/// {@tool dartpad}
/// This sample shows all the variants of [OptimizedFloatingActionButton] widget as
...
///
/// {@tool dartpad}
/// This sample shows [OptimizedFloatingActionButton] with additional color mappings as
/// described in: https://m3.material.io/components/floating-action-button/overview.
///
...
class OptimizedFloatingActionButton extends StatelessWidget {
  ...
  ///
  @ParamFrom('OptimizedFloatingActionButton.')
  ...
  /// The [elevation], [focusElevation], [hoverElevation], [highlightElevation],
  /// and [disabledElevation] parameters, if specified, must be non-negative.
  OptimizedFloatingActionButton.large({
    super.key,
    this.child,
    this.tooltip,
    this.foregroundColor,
  ...
  OptimizedFloatingActionButton.extended({
    super.key,
    this.tooltip,
    this.foregroundColor,
    this.backgroundColor,
  ...
  /// The splash color for this [OptimizedFloatingActionButton]'s [InkWell].
  ///
  ...
  /// [OptimizedFloatingActionButton] per route (that is, per screen), since otherwise
  ...
  /// The padding for an extended [OptimizedFloatingActionButton]'s content.
  ///
  ...
  /// The text style for an extended [OptimizedFloatingActionButton]'s label.
  ///
  ...
  Widget build(BuildContext context) {
    ...
    FloatingActionButtonThemeData defaults = theme.useMaterial3
    ...
    double elevation = this.elevation ??
        ...
        defaults.elevation!;
    double focusElevation = this.focusElevation ??
        floatingActionButtonTheme.focusElevation ??
        defaults.focusElevation!;
    double hoverElevation = this.hoverElevation ??
        floatingActionButtonTheme.hoverElevation ??
        defaults.hoverElevation!;
    double disabledElevation = this.disabledElevation ??
        floatingActionButtonTheme.disabledElevation ??
        defaults.disabledElevation ??
        elevation;
    double highlightElevation = this.highlightElevation ??
        floatingActionButtonTheme.highlightElevation ??
        defaults.highlightElevation!;
    MaterialTapTargetSize materialTapTargetSize =
        this.materialTapTargetSize ?? theme.materialTapTargetSize;
    bool enableFeedback = this.enableFeedback ??
        floatingActionButtonTheme.enableFeedback ??
        defaults.enableFeedback!;
    double iconSize = floatingActionButtonTheme.iconSize ?? defaults.iconSize!;
    TextStyle extendedTextStyle = (this.extendedTextStyle ??
    ...
    switch (_floatingActionButtonType) {
      ...
      case _FloatingActionButtonType.extended:
        ...
        double iconLabelSpacing = extendedIconLabelSpacing ??
            floatingActionButtonTheme.extendedIconLabelSpacing ??
            8.0;
        EdgeInsetsGeometry padding = extendedPadding ??
...
class _EffectiveMouseCursor extends MaterialStateMouseCursor {
  _EffectiveMouseCursor(this.widgetCursor, this.themeCursor);
